...
void
esh_pipeline_helper(struct esh_pipeline *pipe, struct list * p_jobs_list, int * p_job_id);//, struct termios * terminal);

void 
esh_command_line_helper(struct esh_command_line *cmdline, struct list * p_jobs_list, int * p_job_id); //, struct termios * terminal);
