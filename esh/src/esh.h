...
struct esh_shell {
    ...
    /* Return job corresponding to pgid */
    struct esh_pipeline * (* get_job_from_pgid)(pid_t pgid);
...
enum job_status  { 
    ...
    TERMINATED,     /* job is terminated via SIGTERM */
    DONE            /* job is exited successfully */
};
